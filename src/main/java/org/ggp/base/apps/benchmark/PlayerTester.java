...
public class PlayerTester {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("Starting up preconfigured player using player class named " + name);
		...
		Gamer gamer = (Gamer) chosenGamerClass.getConstructor().newInstance();
		System.out.println("Benchmark score for random player: " + getBenchmarkScores(gamer));
	}
}